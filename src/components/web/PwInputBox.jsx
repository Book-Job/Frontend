  ...
  return (
    <div className='relative flex flex-col items-start justify-center line-clamp-1'>
      <input
        ...
        className={`${PwInputBoxSize[size]} border border-gray-8e8e8e rounded px-4 text-[16px] text-black placeholder:text-gray-8e8e8e focus:border-main-color-pink focus:outline-none`}
