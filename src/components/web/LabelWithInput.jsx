  ...
  return (
    <div className='flex flex-col items-start justify-center w-full'>
      ...
      <input
        ...
        className={`${LabelWithInputBoxSize[size]} border border-dark-gray rounded px-4 text-[16px] text-black placeholder:text-dark-gray focus:border-main-pink focus:outline-none`}
        ref={ref}
        {...rest}
      />
    </div>
