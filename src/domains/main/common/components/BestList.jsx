          ...
          return (
            <div key={index} className='flex items-center'>
              ...
              <div className='flex sm:text-[20px] text-[15px] font-medium items-center justify-between w-full ml-3'>
                <button className='flex justify-start w-auto line-clamp-1' onClick={() => navigate(path)}>
                  {title}
                </button>
                <div className='flex flex-row items-center'>
                  <img src={comment} alt='comment' className='sm:w-[19px] w-[15px] h-[13px] sm:h-[17px] mr-2' />
                  {commentNum}
                </div>
              </div>
            </div>
