  ...
  return (
    <div>
      <div className='flex flex-row items-center justify-between bg-[#F0F0F0] w-full sm:h-[275px] h-[190px] sm:pl-16 sm:pr-12 pl-7 pr-5 py-7'>
        ...
        <div className='flex'>
          <button className='border border-dark-gray rounded-[5px] sm:w-[254px] sm:h-[66px] w-28 h-10 font-bold sm:text-2xl text-base' onClick={() => navigate(ROUTER_PATHS.MY_EDIT_PROFILE)}>
            프로필 수정
          </button>
        </div>
      </div>
